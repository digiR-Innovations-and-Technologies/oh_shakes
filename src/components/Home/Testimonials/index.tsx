...
const reviewsData = [
  ...
  },
  {
    id: 5,
    name: "Tom Brown",
    review: "Best espresso in town! Will definitely be coming back for more.",
    rating: 5,
  },
];
      ...
      <div className="px-4 py-12 flex items-center bg-dark-brown justify-center">
        <div className="max-w-screen-xl mx-auto overflow-hidden">
          ...
          <p className="text-xl text-white text-center md:w-2/3 md:mx-auto mt-2 mb-4 leading-relaxed">
            Our cafe is loved by customers for its cozy atmosphere and excellent
            coffee. Here are some of the things our visitors have shared about
            their experience.
          </p>
